...
const placeCoordinates: Record<string, [number, number]> = {
    'Festas de Oeiras - JARDIM MUNICIPAL DE OEIRAS                (PS - MIRAFLORES OS QUE SÃO ESTAO AI A DIZER)': [38.6946, -9.3113],
    'Tires (21h45)': [38.7214, -9.3364],
    'Arraial de Benfica          by                           SUPER BOCK': [38.7511, -9.2014],
    'Arraial Belém': [38.6967, -9.2064],
    'Arraial Campo Pequeno (Avenidas Novas)': [38.7423, -9.1447],
    'Arraial Praça de Londres (Areeiro)': [38.7402, -9.1362],
    ...
    'Arraial dos Combatentes (Rua Possidónio da Silva nº206)': [38.7058, -9.1724],
    'Arraial da Fonte Santa                             (Rua Possidónio da Silva)': [38.7062, -9.1720],
    ...
    'Arraial de São Vicente (Largo da Graça)': [38.7175, -9.1310],
    'Arraial de Alcântara (Rua da Cascalheira Alcântara)': [38.7037, -9.1795],
